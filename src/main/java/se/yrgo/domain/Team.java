...
public class Team {
	...
	public Team(String details, Calendar requiredBy, String owningUser){
	...
	public Team(String actionId, String details, Calendar requiredBy, String owningUser, boolean complete){
		this.details = details;
		this.requiredBy = requiredBy;
		this.owningUser = owningUser;
